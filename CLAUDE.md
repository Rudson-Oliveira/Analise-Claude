...
1. Leia **[ORACULO.md](./ORACULO.md)** — base de conhecimento completa (handoff p/ agentes).
...
| Arquivo | Papel |
|---|---|
| `ORACULO.md` | **Base de conhecimento completa** (handoff p/ qualquer agente) — leia primeiro |
